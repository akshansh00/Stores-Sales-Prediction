...
class DataIngestion:
    ...
    def download_dataset(self,download_url: str, download_file_path: str) -> str:
        try:
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        try:
            ...
            train_dataset_download_url = data_ingestion_config.dataset_download_url
            raw_file_path = data_ingestion_config.raw_data_dir
            self.download_dataset(train_dataset_download_url, raw_file_path)
